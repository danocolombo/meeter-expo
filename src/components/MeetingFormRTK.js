        ...
        >
            ...
            <View style={mtrStyles(mtrTheme).row}>
                ...
                >
                    <View style={mtrStyles(mtrTheme).dateContainer}>
                        {Platform.OS === 'ios' && dateValue?.toISOString() && (
                            <View style={mtrStyles(mtrTheme).dateWrapperIOS}>
                                <DateBall
                                    date={`${
                        ...
                        {Platform.OS === 'android' && (
                            <View
                                style={mtrStyles(mtrTheme).dateWrapperAndroid}
                            >
                                <DateStack
                                    date={`${
                                        dateValue?.getUTCMonth() + 1
            ...
            {authority && (
                <View style={mtrStyles(mtrTheme).row}>
                    ...
                    <View style={mtrStyles(mtrTheme).currencyInputContainer}>
                        <CurrencyInput
